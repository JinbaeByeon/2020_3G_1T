...
XMFLOAT3 CGraphicsPipeline::Project(XMFLOAT3& xmf3Model)
{
	XMMATRIX xmmtxModelToProject =
		XMMatrixMultiply(XMLoadFloat4x4(m_pxmf4x4World), XMLoadFloat4x4(m_pxmf4x4ViewProject));
	XMVECTOR xmv4Project;
	xmv4Project = XMVector3Transform(XMLoadFloat3(&xmf3Model), xmmtxModelToProject);
