...
void XM_CALLCONV Draw2DLine(HDC hDCFrameBuffer, XMFLOAT3& f3PreviousProject, XMFLOAT3& f3CurrentProject)
{
...
void CMesh::Render(HDC hDCFrameBuffer)
{
	...
	for (int j = 0; j < m_nPolygons; j++)
	{
		...
		{
			XMFLOAT3 f3CurrentProject = CGraphicsPipeline::Project(pVertices[i].m_f3Position);
