...
void CScene::BuildObjects()
{
	...
	m_ppObjects[0]->SetRotationSpeed(4.5f, 0.0f, 0.0f);
	m_ppObjects[0]->SetColor(RGB(255, 255, 0));

	m_ppObjects[1] = new CGameObject();
	m_ppObjects[1]->SetMesh(pCubeMesh);
	m_ppObjects[1]->SetPosition(-10.0f, 0.0f, -14.0f);
	m_ppObjects[1]->SetRotationSpeed(0.0f, 4.5f, 0.0f);
	...
	m_ppObjects[2]->SetRotationSpeed(0.0f, 4.5f, 9.0f);
	...
	m_ppObjects[3]->SetRotationSpeed(1.5f, 9.0f, 4.5f);
	...
	m_ppObjects[4]->SetRotationSpeed(4.5f, 6.5f, 0.0f);
